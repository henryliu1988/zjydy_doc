...
public class WebCall {
    ...
    public Observable<WebResponse> call(int methodId, HashMap<String, Object> params, boolean needToast) {
        if (!WebKey.WEBKEY_FUNC_COMMON_MAP.containsKey(methodId)
                && !WebKey.WEBKEY_FUNC_HUAN_MAP.containsKey(methodId)
                && !WebKey.WEBKEY_FUNC_ZHUAN_MAP.containsKey(methodId)) {
    ...
    public Observable<WebResponse> call(int methodId, HashMap<String, Object> params) {
        if (!WebKey.WEBKEY_FUNC_COMMON_MAP.containsKey(methodId) && !WebKey.WEBKEY_FUNC_HUAN_MAP.containsKey(methodId)  && !WebKey.WEBKEY_FUNC_ZHUAN_MAP.containsKey(methodId)) {
            WebResponse response = new WebResponse(1, "没有此接口", null);
            return Observable.just(response);
        }
        return callWebService(new WebService(methodId,
